...
![1605106676640](D:\softWares\Typora\TyporeStores\typora-user-images\1605106676640.png)
...
![1581335409668](../../../typora-user-images/1581335409668.png)
...
用于加载服务的具体实现。为什么能通过ServiceLoader.load(Driver.class)这样的 Driver.Class 就能加载实现类，原因就是ServiceLoader里面直接定义了加载的服务的路径，然后会读取这个文件每一行。

![1569230912209](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1569230912209.png)
...
![1569310338574](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1569310338574.png)
...
![1581436794995](../../../typora-user-images/1581436794995.png)
...
![1581342097120](../../../typora-user-images/1581342097120.png)
...
![1606058582937](D:\softWares\Typora\TyporeStores\typora-user-images\1606058582937.png)

![1606058615179](D:\softWares\Typora\TyporeStores\typora-user-images\1606058615179.png)
   ...
   private class LazyIterator implements Iterator<S>{
       ...
       public S next() {
        ...
        private S nextService() {
            ...
            Class<?> c = null;
            try {
                // 创建 Class 对象实例。根据 hasNextService 方法设置的nextName，也就是找到的 Class 对象的完全限定名，调用forName方法，这里指定了线程上下文加载器
