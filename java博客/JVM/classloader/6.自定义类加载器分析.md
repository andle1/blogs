...
![1605367380035](6.自定义类加载器分析.assets/1605367380035.png)
...
![1605279941335](6.自定义类加载器分析.assets/1605279941335.png)

这个父类的构造方法会通过 getSystemClassLoader() 获取系统类加载器作为新类加载器的父类加载器。

![1605279974036](6.自定义类加载器分析.assets/1605279974036.png)
...
![1605366035783](6.自定义类加载器分析.assets/1605366035783.png)
