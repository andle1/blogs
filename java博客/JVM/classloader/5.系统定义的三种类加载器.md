...
![1605710257344](5.系统定义的三种类加载器.assets/1605710257344.png)
...
![1605710701794](5.系统定义的三种类加载器.assets/1605710701794.png)
...
![1605625339096](5.系统定义的三种类加载器.assets/1605625339096.png)

先打包成 jar 包：

![1605625096487](5.系统定义的三种类加载器.assets/1605625096487.png)

编译结果出现了 jar包，这时候同时存在 MyTest1.class 和 Test.jar

![1605625453702](5.系统定义的三种类加载器.assets/1605625453702.png)

这时候再去更改加载路径，就会成功：

![1605625541650](5.系统定义的三种类加载器.assets/1605625541650.png)
...
![1605711111548](5.系统定义的三种类加载器.assets/1605711111548.png)
...
![img](5.系统定义的三种类加载器.assets/{44B37513-67A1-F6E8-3676-F49E094274ED}-1605107640630.jpg)
